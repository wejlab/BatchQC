...
- name: Jessica McClintock
  affiliation: Division of Infectious Disease, Department of Medicine, Rutgers University 
...
you would expect your samples to cluster and be more similar to samples from the 
...
dendrogram_plot <- BatchQC::dendrogram_plotter(se = se_object, assay = "counts", 
    batch_var = "batch", category_var = "condition")
...
```{r}
circular_dendrogram_plot <- BatchQC::dendrogram_plotter(se = se_object, 
    assay = "counts", batch_var = "batch", category_var = "condition")
...
differential_expression <- BatchQC::DE_analyze(se = se_object, 
    method = "DESeq2", batch = "batch", conditions = c("category"), assay_to_analyze = "counts")
```
